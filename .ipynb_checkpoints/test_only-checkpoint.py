...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_json', default="/.json")
    
    parser.add_argument('--root', default="./total")
    
    parser.add_argument('--total_list', default="./total.txt")
    ...
    parser.add_argument('--zum_test_list', default="./pair.txt")
